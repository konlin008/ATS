...
export default function Register() {
  ...
  const { mutate, data, success, error } = useRegister();
  ...
  return (
    <div className="min-h-screen w-full flex items-stretch bg-white font-sans">
      <div className="hidden lg:flex lg:w-2/5 relative bg-blue-100 flex-col justify-between px-12 py-14 overflow-hidden">
        <Sparkles
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="relative bg-white rounded-2xl shadow-xl shadow-slate-200/60 w-56 h-64 p-5 flex flex-col gap-3">
            ...
            <div className="flex-1 flex items-center justify-center">
              <div className="w-20 h-20 rounded-full bg-white border-4 border-emerald-400 shadow-md flex items-center justify-center">
                <span className="text-xl font-bold text-slate-800">92</span>
              </div>
            </div>
            <div className="flex items-end gap-1 h-6 justify-end">
              <div className="w-1.5 bg-emerald-400 rounded-sm h-2" />
              <div className="w-1.5 bg-emerald-400 rounded-sm h-4" />
              <div className="w-1.5 bg-emerald-400 rounded-sm h-6" />
            </div>
          </div>
        </div>
        <div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 sm:px-10 py-12 bg-white">
        <div className="w-full max-w-sm">
          ...
          <p className="text-slate-500 text-sm mb-7">
            Join Scorio and start boosting your ATS score.
          </p>
          ...
          <form className="space-y-5" onSubmit={register}>
            ...
            <div>
              ...
              >
                <span
                  className={`inline-flex w-3.5 h-3.5 rounded-full items-center justify-center text-[9px] ${
                    passwordValid
